...
public abstract class CipherStrategy {
	 ...
	 * @return
	 */
	public abstract String encrypt(String content)throws Exception;
	 ...
	 * @return
	 */
	public abstract String decrypt(String encryptContent)throws Exception;

    public abstract String decryptByPublic(String encryptContent) throws Exception;
