package com.taihaoli.statisticssdk.utils;
...
/**
 * The class <code>CrashHandler</code>
 * 
 * @version 1.0
 */
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    /** 用于日期格式化，作为日志文件的一部分 */
    private final DateFormat formatter = new SimpleDateFormat("yyyyMMddHHmmss", Locale.CHINA);
    /** 保存crash的文件 */
